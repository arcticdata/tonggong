...
class TestCaseMixin(unittest.TestCase):
    ...
    def ok(self, response, status_code=http.HTTPStatus.OK, **kwargs):
    ...
    def ok_201(self, response, **kwargs):
        return self.ok(response, http.HTTPStatus.CREATED, **kwargs)

    def ok_204(self, response, **kwargs):
        return self.ok(response, http.HTTPStatus.NO_CONTENT, **kwargs)

    def bad(self, response, **kwargs):
        return self.ok(response, http.HTTPStatus.BAD_REQUEST, **kwargs)

    def not_found(self, response, **kwargs):
        return self.ok(response, http.HTTPStatus.NOT_FOUND, **kwargs)

    def forbidden(self, response, **kwargs):
        return self.ok(response, http.HTTPStatus.FORBIDDEN, **kwargs)
