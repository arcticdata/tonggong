...
class RedisTestCase(unittest.TestCase):
    ...
    def test_safe_delete_has(self):
        ...
        self.assertEqual(self.conn.hlen(key), 0)
    ...
    def test_safe_delete_list(self):
        ...
        self.assertEqual(self.conn.llen(key), 0)
    ...
    def test_safe_delete_set(self):
        ...
        self.assertEqual(self.conn.scard(key), 0)
    ...
    def test_safe_delete_sorted_set(self):
        ...
        self.assertEqual(self.conn.zcard(key), 0)
